...
const translations = {
  de: {
    ...
    langSwitch: 'EN',
    toolOverviewBack: 'Zur Tool-Uebersicht',

    hubEyebrow: 'NOVAMOTIS Tools',
    hubTitle: 'Alle Konfiguratoren und Planungstools an einem Ort',
    hubSubtitle: 'Diese Uebersicht wird Schritt fuer Schritt erweitert. Verfuegbare Tools koennen direkt gestartet werden, geplante Module werden hier nach und nach freigeschaltet.',
    hubSectionTitle: 'Tool-Uebersicht',
    hubSectionSubtitle: 'Heute verfuegbare und geplante Konfiguratoren im schnellen Zugriff.',
    hubAvailableNow: 'Bereits verfuegbar',
    hubGrowingLibrary: 'Wird laufend erweitert',
    hubOpenTool: 'Tool oeffnen',
    hubPlanned: 'In Planung',
    hubPlannedHint: 'Dieses Modul wird als naechstes vorbereitet.',
    hubToolBeltTitle: 'Gurtfoerderer-Konfigurator',
    ...
    hubToolDeflectionDesc: 'Geplantes Tool zur schnellen Vorpruefung von Profilen, Lasten und zulaessiger Durchbiegung.',
    hubToolDoorTitle: 'Schnelllauftor-Konfigurator',
    hubToolDoorDesc: 'Geplantes Modul fuer Schnelllauftore mit technischer Vorauswahl und Anfrageprozess.',
    hubToolRollerTitle: 'Rollenbahnen',
    hubToolRollerDesc: 'Geplante Uebersicht fuer angetriebene und nicht angetriebene Rollenbahnen inklusive Variantenwahl.',
    ...
    privacyConsentLink: 'Datenschutzerklaerung',
