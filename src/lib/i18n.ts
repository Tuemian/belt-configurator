...
const translations = {
  de: {
    ...
    hubToolDeflectionDesc: 'Schnelle Vorprüfung: Profil, Spannweite und Last wählen und die Durchbiegung berechnen.',
  ...
  en: {
    ...
    hubToolDeflectionDesc: 'Quick pre-check: choose a profile, span and load, and calculate the deflection.',
  ...
  it: {
    ...
    hubToolDeflectionDesc: 'Pre-verifica rapida: scegli profilo, luce di calcolo e carico per calcolare la freccia.',
