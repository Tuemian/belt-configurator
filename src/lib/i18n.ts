...
const translations = {
  de: {
    ...
    hubBeta: 'Beta-Zugang',
    hubOpenWithPassword: 'Mit Passwort öffnen',
    hubPasswordTitle: 'Beta-Zugang',
    hubPasswordLabel: 'Bitte Zugangspasswort eingeben',
    hubPasswordError: 'Falsches Passwort. Bitte erneut versuchen.',
  ...
  en: {
    ...
    hubBeta: 'Beta access',
    hubOpenWithPassword: 'Open with password',
    hubPasswordTitle: 'Beta access',
    hubPasswordLabel: 'Please enter the access password',
    hubPasswordError: 'Incorrect password. Please try again.',
  ...
  it: {
    ...
    hubBeta: 'Accesso beta',
    hubOpenWithPassword: 'Apri con password',
    hubPasswordTitle: 'Accesso beta',
    hubPasswordLabel: 'Inserisci la password di accesso',
    hubPasswordError: 'Password errata. Riprovare.',
